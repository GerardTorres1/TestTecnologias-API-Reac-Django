...
SECRET_KEY = "django-insecure-(+k$2%#^%4(!)sa(z)mbdwxf+kkv@-%y3(9wq!1z8rrfj@du(!"
...
# Lo que hace esto es listar las urls de las que se pueden hacer peticiones
CORS_ORIGIN_WHITELIST = [
    'http://localhost:3000',
]

# En caso se quiera abrir a todas las urls
